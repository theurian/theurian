...
| T-15 | A secret in a document becomes an approved, indexed revision | Information disclosure | High | SEC-11 — no content scanner ships; human review of the authored migration (ADR-0013) and supersede/retire are what stand, and the scanner is owed with the write path in M7 ([#198](https://github.com/theurian/theurian/issues/198)) |
