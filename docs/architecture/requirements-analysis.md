...
| T-7 | A hostile Git URL triggers an internal request | SSRF | Medium | SEC-10 — `$ref` recorded-never-fetched only; the repository allowlist is owed with M7 ([#129](https://github.com/theurian/theurian/issues/129)) |
