...
def test_a_gitless_copy_scans_the_population_the_harness_recorded(
    ...
    enough; ``dogfood/dev7-corpus`` tracks 81 files under ``.theurian/`` (measured
    2026-08-20) -- 26 knowledge documents, 26 migrations, 26 proposal evidence
    files and 3 ``.gitkeep`` placeholders, 78 of them with a suffix the scan
    reads -- and the guess refuses that directory wholesale. Corrected here to
    match ``command_population.py``'s own note on :func:`_walked`: an earlier
