...
_INFRASTRUCTURE_NON_SERVING_MODULES: frozenset[str] = frozenset(
    {
        ...
        # cat-file` to decide whether a migration is committed at HEAD; it touches
        # neither the findings store nor the *findings* write path (WRITE_PATH_MODULES,
        # which stays application/cli) -- the migration write path is a different arm.
