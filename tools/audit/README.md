...
| `threat_model_owner_cites.py` | POP-2, the [#427](https://github.com/theurian/theurian/issues/427) owner-cite sweep: every bracketed `[#N]`, one row per occurrence, with the context a classifier reads. Whether a cite is an owner or a history is *not* decidable here — see the module docstring | 114 cites / 56 numbers / 110 lines, and 97 bare-`#N` escapes ([work log](../../docs/work-logs/2026-08-31-427-owner-cite-sweep.md)) |
