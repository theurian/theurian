...
#427 sweep's own fixes to the threat model took its row from 114/56/110/97 to
119/57/114/109 in the same branch. Read a row against the commit it names, or
re-run it and record the new anchor beside the new number.
